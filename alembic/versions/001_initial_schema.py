...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_transcript_segments_video_id"),
        "transcript_segments",
        ["video_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_transcript_segments_user_id"),
        "transcript_segments",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_transcript_segments_user_id"), table_name="transcript_segments"
    )
    op.drop_index(
        op.f("ix_transcript_segments_video_id"), table_name="transcript_segments"
    )
