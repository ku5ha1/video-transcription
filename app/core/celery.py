...
def process_video_task(self, object_name: str, filename: str, user_id: str, video_id: str):
    """
    ...
    async def run_task():
        ...
        try:
            logger.info(f"Starting video processing task for {filename} (user: {user_id}, video: {video_id})")
